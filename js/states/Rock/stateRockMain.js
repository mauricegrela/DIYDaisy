...
this.game.scale.refresh();
    ...
    create: function () {
        ...
        this.StickerButton1 = gameButtons.addStickerButton("0", ButtonsPos_x, ButtonsPos_y, this.Sticker_1_Place, this,0,"Rock_Stickers"); 
        StickerGroup.add(this.StickerButton1);
        
        this.StickerButton2 = gameButtons.addStickerButton("0", ButtonsPos_x, ButtonsPos_y+60, this.Sticker_2_Place, this,1,"Rock_Stickers"); 
        StickerGroup.add(this.StickerButton2);
        
        this.StickerButton3 = gameButtons.addStickerButton("0", ButtonsPos_x+80, ButtonsPos_y, this.Sticker_3_Place, this,2,"Rock_Stickers");  
        StickerGroup.add(this.StickerButton3);
        
        this.StickerButton4 = gameButtons.addStickerButton("0", ButtonsPos_x+80, ButtonsPos_y+60, this.Sticker_4_Place, this,3,"Rock_Stickers");
        StickerGroup.add(this.StickerButton4);
        
        this.StickerButton5 = gameButtons.addStickerButton("0", ButtonsPos_x+160, ButtonsPos_y, this.Sticker_5_Place, this,4,"Rock_Stickers"); 
        StickerGroup.add(this.StickerButton5);
        
        this.StickerButton6 = gameButtons.addStickerButton("0", ButtonsPos_x+160, ButtonsPos_y+60, this.Sticker_6_Place, this,5,"Rock_Stickers"); 
        StickerGroup.add(this.StickerButton6);
        
        this.StickerButton7 = gameButtons.addStickerButton("0", ButtonsPos_x+240, ButtonsPos_y, this.Sticker_7_Place, this,6,"Rock_Stickers");  
        StickerGroup.add(this.StickerButton7);
        
        this.StickerButton8 = gameButtons.addStickerButton("0", ButtonsPos_x+240, ButtonsPos_y+60, this.Sticker_8_Place, this,7,"Rock_Stickers");
        ...
        //Rock Body
        this.RockBody = game.add.sprite(GameCenter_x, GameCenter_y, 'RockBody');   
        this.RockBody.anchor.set(0.5);
        this.RockBody.alpha = 1;
        this.RockBody.inputEnabled = true;
        this.RockBody.input.pixelPerfectOver = true;
        this.RockBody.events.onInputOver.add(this.BodyClick, this);    
        Character.add(this.RockBody); 
        
        //Sticker_1_1
        this.Sticker_1 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockAntenae_1');        
        ...
        //Sticker_2      
        this.Sticker_2 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockAntenae_2');
        ...
        //Sticker_3
        this.Sticker_3 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockWings_1');
        ...
        //Sticker_4
        this.Sticker_4 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockWings_2');
        ...
        //Sticker_5
        this.Sticker_5 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockFace_1');        
        ...
        //Sticker_6      
        this.Sticker_6 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockFace_2');
        ...
        //Sticker_7
        this.Sticker_7 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockFeet_1');
        ...
        //Sticker_8
        this.Sticker_8 = game.add.sprite(GameCenter_x, GameCenter_y, 'RockFeet_2');
    ...
    { 
        ...
        {
        this.RockBody.tint = SelectedColor;
   ...
   Sticker_8Click: function () {
    ...
    SaveClicked: function () {game.state.start("StateRockOuttro")},
